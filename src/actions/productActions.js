...
export const createProduct = () => async (dispatch, getState) => {
    ...
    try{
        const {data} = await Axios.post(
            'https://sahayata-mern-stack.herokuapp.com/api/products',{},{
...
export const deleteProduct = (productId) => async (dispatch, getState) => {
    ...
    try {
    const { data } = Axios.delete(`https://sahayata-mern-stack.herokuapp.com/api/products/${productId}`, {
        headers: { Authorization: `Bearer ${userInfo.token}` },
    });
...
export const createReview = (productId, review) => async (
    ...
    try {
    const { data } = await Axios.post(
        `https://sahayata-mern-stack.herokuapp.com/api/products/${productId}/reviews`,
        review,
        {
        headers: { Authorization: `Bearer ${userInfo.token}` },
        }
